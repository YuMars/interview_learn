...
typedef CF_OPTIONS(CFOptionFlags, CFRunLoopActivity) {
    kCFRunLoopEntry = (1UL << 0), // 开始
    kCFRunLoopBeforeTimers = (1UL << 1), // 开启计时器之前
    kCFRunLoopBeforeSources = (1UL << 2), // 开始source之前
    kCFRunLoopBeforeWaiting = (1UL << 5), // 开始等待之前
    kCFRunLoopAfterWaiting = (1UL << 6), // 等待
